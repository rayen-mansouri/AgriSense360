...
#[Route('/{id}/modifier', name: 'front_produit_edit', methods: ['GET', 'POST'])]
public function edit(
    Request $request,
    Produit $produit,
    EntityManagerInterface $em
): Response {
    // PAS DE VÉRIFICATION DE SÉCURITÉ (temporaire pour tests)
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        // Gérer le stock
        $this->handleStockData($request, $produit, $em);
