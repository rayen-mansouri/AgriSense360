...
class FrontController extends AbstractController
{
    ...
    public function editStock(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('front_produit_show', ['id' => $stock->getProduit()->getId()]);
        }

        return $this->render('front/stock/edit.html.twig', [
            'form'    => $form->createView(),
            'stock'   => $stock,
            'title'   => '✏️ Modifier le stock',
            'subtitle' => 'Pour le produit : ' . $stock->getProduit()->getNom(),
            'btnLabel' => 'Enregistrer les modifications',
        ]);
    }
