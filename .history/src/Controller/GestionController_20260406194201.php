...
public function produitNew(Request $request): Response
{
    ...
    // Définir l'agriculteur_id par défaut
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        if (!$photoFile) {
            $this->addFlash('error', '❌ La photo du produit est obligatoire.');
        ...
        // Lier le stock au produit
        $stock->setProduit($produit);
        
        // Persister d'abord le produit
        $this->em->persist($produit);
        $this->em->flush();
        
        // Puis persister le stock
    ...
    return $this->render('templates/produit/form.html.twig', [
    ...
    #[Route('/produit/{id}/modifier', name: 'produit_edit', methods: ['GET', 'POST'])]
public function produitEdit(Request $request, Produit $produit): Response
{
    // Récupérer le stock existant ou en créer un nouveau
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        // Gérer la photo (optionnelle en modification)
        $photoFile = $form->get('produit')->get('photoFile')->getData();
        ...
        // S'assurer que le stock est lié au produit
    ...
    return $this->render('templaproduit/form.html.twig', [
        'form' => $form->createView(),
        'produit' => $produit,
...
public function produitDelete(Request $request, Produit $produit): Response
{
    ...
    #[Route('/stock/{id}/modifier', name: 'stock_edit', methods: ['GET', 'POST'])]
    public function stockEdit(Request $request, Stock $stock): Response
    {
    ...
    public function stockDelete(Request $request, Stock $stock): Response
    {
