...
public function produitNew(Request $request): Response
{
    ...
    // On crée un formulaire unique avec un FormBuilder (comme pour le stock)
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        // Gestion de la photo (obligatoire en création)
        ...
        $this->handlePhoto($form->get('produit'), $produit);

        $produit->setAgriculteurId(1);   // À adapter selon ton système d'auth
        ...
        return $this->redirectToRoute('home');   // ou 'admin' selon ton choix
    }
