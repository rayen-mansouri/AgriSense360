...
#[Route('/export/excel/alertes', name: 'export_excel_alertes')]
public function exportExcelAlertes(ExcelExportService $excelService): Response
{
    return $excelService->exportAlertes();
}
