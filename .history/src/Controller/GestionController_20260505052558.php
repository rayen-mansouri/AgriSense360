...
class GestionController extends AbstractController
{
    ...
    #[Route('/dashboardstock', name: 'admin')]
    public function dashboard(Request $request): Response
    {
        ...
        return $this->render('dashboardstock/index.html.twig', [
            'produits'      => $produits,
            'stocks'        => $stocks,
            'alertes'       => $alertes,
...
{
     $produits = $produitRepo->findBy([], ['nom' => 'ASC'], 100);
...
public function commodityView(ProduitRepository $produitRepo): Response
{
    ...
    $produits = $produitRepo->findBy([], ['nom' => 'ASC'], 200);
