...
class ManagementControllerTest extends TestCase
{
    ...
    {
        $this->assertTrue(method_exists($this->controller, 'workers'));
        $this->assertTrue(method_exists($this->controller, 'editWorker'));
        $this->assertTrue(method_exists($this->controller, 'adminAnimals'));
    }
