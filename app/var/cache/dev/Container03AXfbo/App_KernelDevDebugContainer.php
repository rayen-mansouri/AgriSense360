...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ManagementController' => 'getManagementControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventSubscriber'.\DIRECTORY_SEPARATOR.'AccessSubscriber.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventSubscriber\\AccessSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\AccessSubscriber'] ?? self::getAccessSubscriberService($container)), 'onKernelRequest'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AuthController', 'App\\Controller\\EquipmentController', 'App\\Controller\\HomeController', 'App\\Controller\\ManagementController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'App\EventSubscriber\AccessSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\AccessSubscriber
     */
    protected static function getAccessSubscriberService($container)
    {
        return $container->privates['App\\EventSubscriber\\AccessSubscriber'] = new \App\EventSubscriber\AccessSubscriber(($container->services['router'] ?? self::getRouterService($container)));
    }
