...
class AffectationTravailController extends AbstractController
{
    ...
    public function show(#[MapEntity(id: 'id_affectation')] AffectationTravail $affectation): Response
    {
    ...
    public function edit(
        Request $request,
        #[MapEntity(id: 'id_affectation')] AffectationTravail $affectation,
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('affectation_travail_show', ['id_affectation' => $affectation->getIdAffectation()]);
        }
    ...
    public function delete(
        ...
        if ($this->isCsrfTokenValid('delete' . $affectation->getIdAffectation(), (string) $request->request->get('_token'))) {
